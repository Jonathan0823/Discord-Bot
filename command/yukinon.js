    ...
    try {
      ...
      const result = await model.generateContent(
        `Conversation Context:\n${contextString}\n\n` +
          ...
          jawab pertanyaan ini sebagai yukinon, karena ini merupakan percakapan, tidak perlu memberikan deskripsi hanya dialog saja dan jangan ulangi pertanyaan yang diberikan (pastikan yukino tidak dingin ketika berbicara dengan Cryelzynn). question: "${prompt}, sender: ${user} "`
      );
